...
@section('content')
                ...
                <div class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">Annee Academique </li>
                        </ul>
                    </div>
                </div>
            </div>
                                        ...
                                        <tbody class="text-gray-600 fw-semibold">
                                            <template x-for="role in paginatedRoles" :key="role.id">
                                                <tr>
                                                    ...
                                                    <td x-text="formatDate(role.date_debut)"></td>
                                                    <td x-text="formatDate(role.date_fin)"></td>
                                                    <td class="text-end">
    ...
    <script>
        function roleManagement() {
            return {
                searchTerm: '',
                roles: @json($listeanneeacademique),
                filteredRoles: [],
                currentPage: 1,
                rolesPerPage: 10,
                totalPages: 0,
                ...
                filterRoles() {
                    ...
                    this.filteredRoles = this.roles.filter(role => role.name.toLowerCase().includes(term));
