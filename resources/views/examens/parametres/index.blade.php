...
<div id="kt_app_content" class="app-content flex-column-fluid">
    <div id="kt_app_content_container" class="app-container container-xxl">
        <div class="card card-flush pb-0 bgi-position-y-center bgi-no-repeat mb-10" style="background-size: auto calc(100% + 10rem); background-position-x: 100%; background-image: url('/keen/demo1/assets/media/illustrations/sketchy-1/4.png')">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="text-muted fw-bold">
                            <div class="text-muted fw-bold">
                                <a href="#">Paramètre de configuration associé aux examens</a> <span class="mx-3">|</span>
                                <a href="#">Rapport examen </a> <span class="mx-3">|</span>
                                La génération du rapport prend en compte les notes et le statut des examens. Toute modification peut affecter le rapport final.
                            </div>
