                    ...
                    <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1"
                        ...
                        <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
                            ...
                            <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
                                ...
                                <!--end:Menu item-->
                                <!--begin:Menu item-->
                                <a href="{{ route('eleves.index') }}" class="menu-item me-0 me-lg-2 {{ request()->routeIs('eleves.index') ? 'active' : '' }}">
                                    <!--begin:Menu link-->
                                    <span class="menu-link">
                    ...
                    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
                        ...
                        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold px-3"
                                ...
                                <a href="{{ route('eleves.index') }}" class="menu-item  {{ request()->routeIs('eleves.index') ? 'active' : '' }}">
                                    <span class="menu-link">
                                        <span class="menu-icon">
                                            <span class="svg-icon svg-icon-2">
