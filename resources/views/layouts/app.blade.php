                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold px-3"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ request()->routeIs('matieres.index') ? 'active' : '' }}"
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ request()->routeIs('niveaux.index') ? 'active' : '' }}"
                                ...
                                <div class="menu-item pt-5">
                                    <div class="menu-content">
                                        <span class="menu-heading fw-bold text-uppercase fs-7">Examens</span>
                                    </div>
                                </div>
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link" href="{{ route('suiviversement.index') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
