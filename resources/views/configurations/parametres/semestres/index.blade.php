                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="text-muted fw-bold">
                                <a href="#">Paramètre de configuration associé aux semestres</a> <span
                                    class="mx-3">|</span>
                    ...
                    <div class="form">
                        ...
                        <div class="fv-row row mb-15">
                            ...
                            <div class="col-md-9">
                                <div class="form-check form-check-custom form-check-solid me-10">
                                    ...
                                    <label class="form-check-label" for="cloturer_switch">Marquer le semestre comme
                                        terminé.</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="fv-row row mb-15">
                            ...
                            <div class="col-md-9">
                                <div class="form-check form-check-custom form-check-solid me-10">
                                    ...
                                    <label class="form-check-label" for="rapport_switch">Créer un document PDF du
                                        semestre.</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-12">
                            <div class="col-md-9 offset-md-3">
                                <button type="button" @click="submitAction()" class="btn btn-primary"
                                    :disabled="isLoading">
                    ...
                    async submitAction() {
                        ...
                        if (!this.code || this.code.trim() === '') {
                            Swal.fire({
                                icon: 'error',
                                title: 'Champ requis',
                                text: 'Veuillez saisir le code du semestre avant de continuer.',
                        ...
                        // Vérification d'une seule action cochée
                        const actions = [this.cloturer, this.decloturer, this.rapport].filter(Boolean);
                        if (actions.length !== 1) {
                            Swal.fire({
                                icon: 'error',
                                title: 'Action invalide',
                                text: 'Veuillez sélectionner une seule action à la fois (clôturer, déclôturer ou générer un rapport).',
                                showConfirmButton: true
                            });
                            this.isLoading = false;
                            return;
                        ...
                        // Afficher une attente pendant le traitement
                        Swal.fire({
                            title: 'Traitement en cours...',
                            text: 'Merci de patienter pendant le traitement des données.',
                        ...
                        try {
                            const response = await fetch('{{ route('configurationnote.action.semestre') }}', {
                                method: 'POST',
                                headers: {
                            ...
                            if (response.ok && !data.error) {
                                Swal.fire({
                                    icon: 'success',
                                    title: 'Succès',
                                    text: data.message ?? 'Action effectuée avec succès.',
                                    showConfirmButton: true
                                });
                            } else {
                                Swal.fire({
                                    ...
                                    text: data.message ?? 'Une erreur s’est produite sur le serveur.',
                                    showConfirmButton: true
                                });
                            }
                        } catch (error) {
                            ...
                            Swal.fire({
                                ...
                                text: "Impossible de joindre le serveur. Veuillez vérifier votre connexion.",
                                showConfirmButton: true
                            });
                        } finally {
                            this.isLoading = false;
